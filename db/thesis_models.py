...
without circular imports. Thesis registers itself on Base.metadata so
calling init_db() creates this table automatically.
"""
...
class Thesis(Base):
    ...
    Cross-source deduplication uses DOI when available (handled in thesis_pipeline.py).
    """
