...
Provides access to 700k+ open-access European PhD theses
...
class DARTEuropeIngestor(BaseThesisIngestor):
        ...
        async with httpx.AsyncClient(timeout=30) as client:
            for query in self.queries:
                try:
                    ...
                    log.warning("dart: query=%r error=%s", query, exc)
        return results
    ...
    def _normalize(self, raw: dict, query: str) -> NormalizedThesis | None:
        ...
        abstract = raw.get("abstract_en") or raw.get("abstract") or ""
